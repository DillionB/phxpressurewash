...
export default function ShopPage() {
    ...
    return (
        <section className="wrap" id="services-shop">
            <h2 className="section-title" style={{ textAlign: 'center' }}>Services</h2>
            ...
            <div className="shop-layout" style={{ marginBottom: '100px' }}>
                <div className="shop-main">
                    {current === 'res' && <Residential />}
                    {current === 'ind' && <Industrial />}
                    {current === 'com' && <Commercial />}
                </div>
                <div className="shop-side" style={{ paddingTop: '100px' }}>
                    <CartSummary />
                </div>
            </div>
        </section>
